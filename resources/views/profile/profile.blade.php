                    ...
                    <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                              <div class="box-body box-profile">
                                ...
                                <p class="text-muted text-center">{{  $data->type .' - '. $data->subject }}</p>
                                ...
                                <ul class="list-group list-group-unbordered">
                                  <li class="list-group-item">
                                      <b>Kelas</b> <a class="pull-right">{{ $data->class }}</a>
                                  </li>
                                  <li class="list-group-item">
                    ...
                    {{-- <div class="col-md-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-pills nav-justified">
                                ...
                                <li><a href="#timeline" data-toggle="tab">Student Result</a></li>
                                <li ><a href="#settings" data-toggle="tab">Exercise</a></li>
                            </ul>
