...
<body>
	<h4>11. Soal tipe basis akar dasar</h4>
	$$\sqrt{<?php echo $bilr ?>}=$$
	<?php
		rootsRule($bilp, $akar);
	...
	?>
	<!-- <h4>12. Soal tipe basis akar penyederhanaan</h4> -->
	<!-- $$\sqrt{<?php echo $bilr2 ?>}+\sqrt{<?php echo $bilr3 ?>}+\sqrt{<?php echo $bilr ?>}=$$ -->
	<?php
		// simRootsRule($bilp, $bilp2, $bilp3, $akar);
	?>
	<h4>12. Soal tipe basis akar penyederhanaan bentuk 2</h4>
	$${<?php echo $bil ?>}\sqrt{<?php echo $bilr3 ?>}+{<?php echo $bil2 ?>}\sqrt{<?php echo $bilr2 ?>}-{\sqrt{<?php echo $bilr ?>}}=$$
	<?php
		simRootsRule($bil, $bil2, $bilp, $bilp2, $bilp3, $akar);
		simRootsMCRule($bil, $bil2, $bilp, $bilp2, $bilp3, $akar);
		simRootsMCRule2($bil, $bil2, $bilp, $bilp2, $bilp3, $akar);
		simRootsMCRule3($bil, $bil2, $bilp, $bilp2, $bilp3, $akar);
		simRootsMCRule4($bil, $bil2, $bilp, $bilp2, $bilp3, $akar);
	?>
	<!-- <h4>14. Soal tipe basis akar variabel alphabet</h4> -->
	<!-- $$\sqrt{{<?php echo $bilra ?>^<?php echo $pn ?>}{<?php echo $bilra2 ?>^<?php echo $pn2 ?>}}$$ -->
	<?php
		// rootsAlpRule($bilra, $bilra2, $pn, $pn2);
	?>
	<h4>14. Soal tipe basis akar variabel alphabet dan numerik</h4>
...
<?php
	...
	function alpRootsMCForm($billa, $bilda, $bilra, $bilra2, $pn, $pn2, $pn_b, $pn_b2){
		if($pn_b==-2 && $pn_b2==-2){
			...
			?>
				$${<?php echo $billa ?>}{<?php echo $bilra ?>^{<?php echo $pn_b ?>}}{<?php echo $bilra2 ?>^{<?php echo $pn_b2 ?>}}{\sqrt{<?php echo $bilda ?><?php echo $bilra ?>^{<?php echo $pn ?>}<?php echo $bilra2 ?>^{<?php echo $pn_2 ?>}}}$$
			<?php
		}
	}
