...
<?php
	// function idenPowerQuestion(){
		...
		while(in_array(($pn = mt_rand(-5, 5)), array(-1, 0, 1))); //random -5 sampai 5, tp tidak boleh mengandung nilai -1, 0, 1
	// }
...
<body>
	<h4>1. Soal tipe basis sama dengan prosedure product rule</h4>
	...
	?>
	<h4>2. Soal tipe basis sama dengan prosedure quotient rule</h4>
	...
	<?php
		...
		/*shuffleOpt($bil1, $opt1, $opt2, $opt3, $opt4, $opt5);*/
	?>
	<h4>3. Soal tipe basis sama dengan power to power rule</h4>
	...
	?>
	<h4>4. Soal tipe basis sama dengan kombinasi antar rule</h4>
	<h4>5. Soal tipe penyederhanaan basis sama dengan kombinasi antar rule</h4>
