...
<body>
	<h4>5. Soal tipe basis sama dengan prosedure product rule dan quotient rule (COR2-PRQR)</h4>
	...
	?>
	<h4>6. Soal tipe basis sama dengan prosedure power rule dan product rule (COR2-PPRPR)</h4>
	...
	<?php
		...
		$opt5 = powpowRule($bil1, $pn1, $pn2, $pn3, $var);
	?>
	<h4>7. Soal tipe basis sama dengan prosedure power rule dan quotient rule  (COR2-PPRQR)</h4>
